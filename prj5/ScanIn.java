...
public class ScanIn {
     ...
     * 
     * @param songListLocation
     *            The file location of the song list
     * @param studentListLocation
     *            The file location of the student list
     */
    ...
    private LinkedList<Song> scanSong(String fileName) {
        ...
        while (file.hasNextLine()) {
            ...
            currentSong =
                    new Song(str[0], str[1], str[3], Integer.parseInt(str[2]));
    ...
    private LinkedList<Student> scanStudent(String fileName) {
        ...
        while (file.hasNextLine()) {
            ...
            if (str.length > 5) {
                ...
                if (str[0].matches("\\d+") && str[2] != "" && str[3] != ""
                        && str[4] != "") {
